...
export const REWRITE_AGENT_SYSTEM_PROMPT = [
	...
	"If one or more source-defined skills would improve the output, load them before writing the final answer.",
	"Only use skills that are defined in this plugin source tree.",
...
export function buildRewritePrompt(rawContent: string): string {
	return [
